...
out << "["
out << (__jinjaLoop0.index)
def __jinjaCollection1 = jinjaSlice(items, 0, 2, null)
for (int __jinjaIndex1 = 0; __jinjaIndex1 < __jinjaCollection1.size(); __jinjaIndex1++) {
    def other = __jinjaCollection1[__jinjaIndex1]
