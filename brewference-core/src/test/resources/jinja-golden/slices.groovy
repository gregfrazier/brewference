...
out << (jinjaToJson(jinjaSlice(items, 1, null, null)))
out << "|"
out << (jinjaToJson(jinjaSlice(items, null, 2, null)))
out << "|"
out << (jinjaToJson(jinjaSlice(items, null, null, 2)))
out << "|"
out << (jinjaToJson(jinjaSlice(items, null, null, -1)))
out << "|"
out << (jinjaToJson(jinjaSlice(items, 1, 4, 2)))
out << "\n"
out.toString()
