...
/** Holds the Groovy helper closures prepended to every compiled template. */
final class JinjaRuntimePrelude {
    ...
    private JinjaRuntimePrelude() {}

    /** Returns the Groovy helper closures required by generated code. */
